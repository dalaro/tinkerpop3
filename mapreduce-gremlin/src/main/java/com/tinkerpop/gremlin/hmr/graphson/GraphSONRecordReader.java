 ...
 */
public class GraphSONRecordReader extends RecordReader<NullWritable, HMRInternalVertex> {

    private final LineRecordReader lineRecordReader;
    private final GraphSONReader graphSONReader;
    private HMRInternalVertex vertex = null;
    ...
    public boolean nextKeyValue() throws IOException {
        ...
        this.vertex = new HMRInternalVertex(v);
        return true;
    }
    ...
    @Override
    public HMRInternalVertex getCurrentValue() {
        return this.vertex;
    }
