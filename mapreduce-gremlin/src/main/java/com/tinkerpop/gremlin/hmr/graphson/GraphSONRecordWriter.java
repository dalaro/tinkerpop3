 ...
 */
public class GraphSONRecordWriter extends RecordWriter<NullWritable, HMRInternalVertex> {
    ...
    @Override
    public void write(final NullWritable key, final HMRInternalVertex vertex) throws IOException {
        if (null != vertex) {
